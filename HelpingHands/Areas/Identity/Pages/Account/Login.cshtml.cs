...
namespace HelpingHands.Areas.Identity.Pages.Account
{
    public class LoginModel : PageModel
    {
        ...
        public LoginModel(SignInManager<HelpingHandsUser> signInManager, ILogger<LoginModel> logger, UserManager<HelpingHandsUser> userManager)
        {
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    {
                        return LocalRedirect("/Admin/Index"); // Redirect to Admin dashboard
                    }
